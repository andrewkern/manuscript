...
the most common study systems in computational genetics---humans, \emph{Drosophila},
and \emph{Arabidopsis} (among others)---are only intended to be a starting point for
future development.  Indeed we envision future work to incorporate common modeling
violations such as selection, gene conversion, and mutational heterogeneity, 
